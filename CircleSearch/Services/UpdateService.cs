...
namespace CircleSearch.Services
{
    ...
    public class UpdateService
    {
        ...
        private const string GitHubRepo  = "CircleSearch";

        private static readonly HttpClient _http = new()
        {
            DefaultRequestHeaders = { { "User-Agent", "CircleSearch-Updater" } },
        ...
        public async Task<bool> CheckForUpdateAsync(CancellationToken ct = default)
        {
            ...
            try
            {
                ...
                var asset = release.Assets.FirstOrDefault(a =>
                    a.Name.StartsWith("CircleSearch.Installer", StringComparison.OrdinalIgnoreCase)
            ...
            CancellationToken ct = default)
        {
            ...
            string tempDir  = Path.Combine(Path.GetTempPath(), "CircleSearchUpdate");
